...
subroutine storm_stats_ideal (xgrid, ygrid, time, ubot, vbot, xcen, ycen, xcor, ycor, &
                    utx, uty, n, rmax, storm_name, storm_track_file, storm_start_time, &
   ...
   real(KIND=r4), dimension(im,jm) :: radial !Wind after scalling and translation speed is applied
   real(KIND=r4), dimension(im,jm) :: tangential !Wind after scalling and translation speed is applied
